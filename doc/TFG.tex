...
\begin{document}
    ...
    \input{sections/02_Redes_Neuronales}
    \input{sections/03_Redes_Neuronales_Convolucionales}
    %\input{sections/04_Herramientas_de_Visualizacion}
    \input{sections/05_Experimentacion}
    \input{sections/06_Conclusiones_y_Futuras_Decisiones}
    \input{sections/07_Anexos.tex}
