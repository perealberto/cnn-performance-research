...
% =========================================================
% Estilos TikZ con paleta de colores para redes neuronales
% =========================================================

\usepackage{xcolor}

% Paleta personalizada
\definecolor{inputcolor}{RGB}{102,194,165}   % verde suave
\definecolor{hiddencolor}{RGB}{141,160,203}  % azul/violeta suave
\definecolor{outputcolor}{RGB}{252,141,98}   % naranja suave
\definecolor{edgecolor}{RGB}{80,80,80}       % gris oscuro para aristas
\definecolor{highlightcolor}{RGB}{231,41,138}% magenta para resaltar
...
% Estilo de arista con peso encima
\tikzset{
	edge weight/.style={
		edge,
		every node/.style={font=\scriptsize, midway, fill=white, inner sep=1pt}
	}
}
